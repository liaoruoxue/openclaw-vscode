...
const emptyBoolMap = (): Record<string, boolean> => ({});
const defaultTheme: Theme = {
  components: {
    AudioPlayer: emptyBoolMap(),
    Button: emptyBoolMap(),
    Card: emptyBoolMap(),
    Column: emptyBoolMap(),
    CheckBox: { container: emptyBoolMap(), element: emptyBoolMap(), label: emptyBoolMap() },
    DateTimeInput: { container: emptyBoolMap(), element: emptyBoolMap(), label: emptyBoolMap() },
    Divider: emptyBoolMap(),
    Image: { all: emptyBoolMap(), icon: emptyBoolMap(), avatar: emptyBoolMap(), smallFeature: emptyBoolMap(), mediumFeature: emptyBoolMap(), largeFeature: emptyBoolMap(), header: emptyBoolMap() },
    Icon: emptyBoolMap(),
    List: emptyBoolMap(),
    Modal: { backdrop: emptyBoolMap(), element: emptyBoolMap() },
    MultipleChoice: { container: emptyBoolMap(), element: emptyBoolMap(), label: emptyBoolMap() },
    Row: emptyBoolMap(),
    Slider: { container: emptyBoolMap(), element: emptyBoolMap(), label: emptyBoolMap() },
    Tabs: { container: emptyBoolMap(), element: emptyBoolMap(), controls: { all: emptyBoolMap(), selected: emptyBoolMap() } },
    Text: { all: emptyBoolMap(), h1: emptyBoolMap(), h2: emptyBoolMap(), h3: emptyBoolMap(), h4: emptyBoolMap(), h5: emptyBoolMap(), caption: emptyBoolMap(), body: emptyBoolMap() },
    TextField: { container: emptyBoolMap(), element: emptyBoolMap(), label: emptyBoolMap() },
    Video: emptyBoolMap(),
  },
  elements: {
    a: emptyBoolMap(), audio: emptyBoolMap(), body: emptyBoolMap(), button: emptyBoolMap(),
    h1: emptyBoolMap(), h2: emptyBoolMap(), h3: emptyBoolMap(), h4: emptyBoolMap(), h5: emptyBoolMap(),
    iframe: emptyBoolMap(), input: emptyBoolMap(), p: emptyBoolMap(), pre: emptyBoolMap(),
    textarea: emptyBoolMap(), video: emptyBoolMap(),
  },
  markdown: {
...
export class Root extends (SignalWatcher(LitElement) as typeof LitElement) {
  ...
  accessor _consumedTheme: Theme | undefined;
  /** Theme with guaranteed fallback — never undefined at render time. */
  get theme(): Theme {
    return this._consumedTheme ?? defaultTheme;
  }
